...
const paymentSuccessPage = () => {
  return (
    ...
    >
      ...
      <Typography>
        Since you signed up during the beta, if you have a feature suggestion please send it to <Link href="mailto:weshouldwatchmailer@gmail.com">WeShouldWatchMailer@gmail.com</Link> with <b>BETA MEMBER FR</b> in the subject line!
      </Typography>
